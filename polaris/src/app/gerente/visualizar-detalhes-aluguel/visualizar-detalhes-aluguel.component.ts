...
export class VisualizarDetalhesAluguelComponent implements OnInit {
  ...
  constructor( private ContractPdfService: ContractPdfService, private gerenteService: GerenteService, private activatedRoute: ActivatedRoute, private location: Location ) { }
